...
public class VentanaMultiplicacion extends JFrame {
    private Container cp;//Declaracion de atributos, algunos privados.
    ...
    private void panel1(){//Panel1 con GridLayout, poner filas, etiquetas
        panel1 = new JPanel();
        panel1.setLayout(new GridLayout(3,1));
        subpro1 = new JLabel
        ("Subprograma", SwingConstants.LEFT);
        title = new JLabel
        ("Tabla de Multiplicar", SwingConstants.CENTER);
        font1 = new Font
        (title.getFont().getFontName(), Font.BOLD, 30);
        title.setFont(font1);
    ...
    private void comboBox(){//Nuevo comboBox con numeros, color y fuente
    ...
    private void panel2(){//Panel2 con GridLayout con bordes
        panel2 = new JPanel();
        panel2.setLayout(new GridLayout(10,3,18,18));
        panel2.setBorder(new EmptyBorder(16,16,16,16));
        space1 = "           ";
        
        int X =10; int Y= 3;//Generamos los botones con bucles y botones[]
        for (int i=0;i<X;i++){
            for (int j=0; j<Y;j++){
                if(j == 0){
                    buttonTable = new JButton(space1+i+space1);
                    fontButton = new Font
                    (buttonTable.getFont().getFontName(), 
                            Font.BOLD, 17);
    ...
    private void panel3(){//Panel3 con GridBagLayout
        panel3 = new JPanel();
    ...
    private void number1(){//Creacion de etiqueta numero1 y datos
        number1 = new JLabel
        ("Numero1:", SwingConstants.CENTER);
        font2 = new Font
        (number1.getFont().getFontName(), Font.BOLD, 16);
    ...
    private void numberField1(){//Creacion de campo texto numero1 y datos
    ...
    private void number2(){//Creacion de etiqueta numero2 y datos
        number2 = new JLabel
        ("Numero2:", SwingConstants.CENTER);
     ...
     private void numberField2(){ //Creacion de campo texto numero2 y datos
    ...
    private void result(){//Creacion de etiqueta resultado y datos
        result = new JLabel
        ("Resultado", SwingConstants.CENTER);
    ...
    private void resultField(){//Creacion de campo texto resultado y datos
    ...
    private void botonSuma(){//Creacion de JButton Sumar y datos
        space2 = "          ";
    ...
    private void subpro2(){//Creacion de etiqueta subprograma iniciado
        subpro2 = new JLabel
        ("Subprograma iniciado", SwingConstants.LEFT);
        gbc.gridx = 0; 
        gbc.gridy = 3; 
        gbc.gridwidth = 1; 
        gbc.gridheight = 1; 
