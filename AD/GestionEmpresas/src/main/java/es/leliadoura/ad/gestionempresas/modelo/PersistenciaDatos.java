...
public interface PersistenciaDatos {
     ...
     *
     * @param contacto objeto a modificar con los campos originales
     * @param modificado objecto con los campos a modificar
     */
     ...
     */
    public Contacto recuperaContacto
     ...
     *
     * @param contrato objeto a modificar con los campos originales
     * @param modificado objecto con los campos a modificar
     */
    public void modificarContrato(Contrato contrato, Contrato modificado);

    /**
     * Recupera un contrato a partir del trabajador, la empresa y la fecha de inicio.
     *
     * @param DNI identificador del trabajador
     * @param NIF identificador de la empresa
