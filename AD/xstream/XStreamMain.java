        ...
        do{
            ...
            switch(n){ 
                ...
                case 3://2 ultimos casos generar produtos y pedidos desde archivos dat                   
                    ...
                    utilidadesXStream.datToXMLMal(rPro,itemPro, itemPed, CPro, CPed);
                    lPro.removeAll(lPro);
                    lPro = utilidadesXStream.datToXML(rPro,itemPro, itemPed, CPro, CPed);             
                    System.out.println("\nMostrado produtos.xml por pantalla");
                    utilidadesXStream.verXML
                    (rPro, itemPro, itemPro, CPro, CPro, lPro); 
                    break;                
                case 4:
                    ...
                    utilidadesXStream.datToXMLMal(rPed, itemPed, itemPro, CPed, CPro);  
                    System.out.println("\nMostrado pedidos.xml por pantalla");
                    lPed.removeAll(lPed);
                    lPed = utilidadesXStream.datToXML(rPed, itemPed, itemPro, CPed, CPro);  
                    System.out.println("\nMostrado pedidos.xml por pantalla");
                    utilidadesXStream.verXML
                    (rPed, itemPed, itemPro, CPed,CPro, lPed); 
                    break;
