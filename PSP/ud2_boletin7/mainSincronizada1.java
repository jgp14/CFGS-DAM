...
import ud2_boletin7.objetoComun1;
import ud2_boletin7.sincronizada1;

public class mainSincronizada1 {
	...
	public static void main(String[] args) {
		...
		try {
			Thread.sleep(10000);
		} catch (InterruptedException ex) { System.out.printf("Interrupcion");
		}
